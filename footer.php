<section id="contact" class="anchor flex relative bg-[#1C1F2D] overflow-hidden bg-no-repeat bg-left-bottom bg-auto group">
    <div class="relative w-full">
        ...
        <div class="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5 z-10">
            ...
            <?php
                $homepageContact = new WP_Query(array(
                    'posts_per_page' => 1,
                    'post_type' => 'contact',
                    'order' => 'ASC',
                ));

                while($homepageContact->have_posts()) {
                    $homepageContact->the_post();
            ?>
                    <aside data-aos="fade-up" data-aos-duration="700" data-aos-anchor-placement="top-bottom" class="bg-[#242839] py-16 px-[25px] lg:col-span-2 lg:px-[85px] lg:py-24 xl:pr-12">
                        <div class="max-w-lg mx-auto text-[#B1B7D6] font-bold text-base leading-loose">
                            ...
                            <h6 class="mt-3 leading-loose" data-aos="fade-right" data-aos-delay="100" data-aos-anchor-placement="top-bottom">
                                <?php the_content(); ?>
                            </h6>
                            <dl class="mt-8 text-base font-bold text-[#6F7490]">
                                <div class="mt-6" data-aos="fade-right" data-aos-delay="150" data-aos-anchor-placement="top-bottom">
                                    ...
                                    <dd class="flex">
                                        ...
                                        <span class="ml-3">
                                            <?php
                                                $phone = str_replace("-","", get_field('phone_number'));
                                            ?>
                                            <a href="tel:+<?php echo $phone; ?>" target="_blank/" class="sm:hover:text-gray-400">
                                ...
                                <div class="mt-3" data-aos="fade-right" data-aos-delay="200" data-aos-anchor-placement="top-bottom">
                                    ...
                                    <dd class="flex">
                                        ...
                                        <span class="ml-3">
                                            <a href="mailto:<?php echo get_field('email'); ?>" target="_blank/" class="sm:hover:text-gray-400">
                                ...
                                <div class="flex mt-10 space-x-4">
                                    ...
                                    ?>
                                            <span data-aos="fade-right" data-aos-delay="550" data-aos-anchor-placement="bottom-bottom">
                                                <a href="<?php echo get_field('facebook'); ?>" target="_blank" class="opacity-75 sm:hover:opacity-100 sm:transition-opacity">
                                    ...
                                    <?php
                                        if(get_field('github')) {
                                    ?>
                                            <span data-aos="fade-right" data-aos-delay="500" data-aos-anchor-placement="bottom-bottom">
                                                <a href="<?php echo get_field('github'); ?>" target="_blank" class="opacity-75 sm:hover:opacity-100 sm:transition-opacity">
                                    ...
                                    ?>
                                            <span data-aos="fade-right" data-aos-delay="450" data-aos-anchor-placement="bottom-bottom">
                                                <a href="<?php echo get_field('linkedin'); ?>" target="_blank" class="opacity-75 sm:hover:opacity-100 sm:transition-opacity">
                                    ...
                                    ?>
                                    <?php
                                        if(get_field('dribbble')) {
                                    ?>
                                            <span data-aos="fade-right" data-aos-delay="400" data-aos-anchor-placement="bottom-bottom">
                                                <a href="<?php echo get_field('dribbble'); ?>" target="_blank" class="opacity-75 sm:hover:opacity-100 sm:transition-opacity">
                                    ...
                                    ?>
                                            <span data-aos="fade-right" data-aos-delay="350" data-aos-anchor-placement="bottom-bottom">
                                                <a href="<?php echo get_field('instagram'); ?>" target="_blank" class="opacity-75 sm:hover:opacity-100 sm:transition-opacity">
